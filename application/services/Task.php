...
class Application_Service_Task {
	 ...
	 * @return Application_Model_Task
	 */
	public function crear($title, $project_id, $users, $user_id, $parent_id) {
		$task = $this->_TaskDao->crear($title, $project_id, $user_id, $parent_id);
	...
	public function getAllByFilters($project_id = null, $status_id = null, $user_id = null, $title = null,
		$parent_id = null) {
		return $this->_TaskDao->getAllByFilters($project_id, $status_id, $user_id, $title, $parent_id);
	}
	...
	public function getUnrevised() {
		return $this->_TaskDao->getUnrevised();
	}
}